...
class AppLocalizations {
  ...
  String get orderBook {
    return Intl.message('Order Book',
        name: 'orderBook',
        desc: 'order_book_text');
  }

  String get marketTrades {
    return Intl.message('Market Trades',
        name: 'marketTrades',
        desc: 'market_trades_text');
  }

  String get coin {
    return Intl.message('coin',
        name: 'coin',
        desc: 'price_text');
  }
  ...
  String get openOrders {
    return Intl.message('openOrders',
        name: 'openOrders',
        desc: 'open_orders_text');
  }

  String get closeOrders {
    return Intl.message('Close Orders',
        name: 'closeOrders',
        desc: 'close_orders_text');
  }

  String get assets {
    return Intl.message('Assets',
        name: 'assets',
        desc: 'assets_text');
  }
