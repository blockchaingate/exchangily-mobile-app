...
ThemeData kThemeData({required bool isDark}) => ThemeData(
      ...
      unselectedWidgetColor: isDark ? Colors.white : black,
      ...
      tabBarTheme: TabBarTheme(
        ...
        unselectedLabelColor: isDark ? white : black,
      ...
      fontFamily: 'Roboto',
      textTheme: TextTheme(
          labelLarge: TextStyle(fontSize: 14, color: isDark ? white : black),
          ...
          titleSmall: TextStyle(
              fontSize: 10.3, color: grey, fontWeight: FontWeight.w500),
          bodyLarge: TextStyle(
              fontSize: 13,
              color: isDark ? white : black,
              fontWeight: FontWeight.w400),
