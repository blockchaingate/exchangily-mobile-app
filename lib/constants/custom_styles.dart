  ...
  static ThemeData kThemeData(
    ...
    return ThemeData(
      appBarTheme: AppBarTheme(
          centerTitle: true,
          titleTextStyle: headText4.copyWith(
              color: getTextColor(sc), fontWeight: FontWeight.bold),
          toolbarTextStyle: TextStyle(color: getTextColor(sc)),
          iconTheme: IconThemeData(color: getTextColor(sc)),
          backgroundColor: sc),
