...
----------------------------------------------------------------------*/
  ...
  Future<Map<String, dynamic>> addGasDo(seed, Decimal amount, {options}) async {
    ...
    var txFee =
        NumberUtil.parseNumStringToDecimal(contractInfo['totalFee'].toString());
    var res1 = await fabUtils.getFabTransactionHexV2(seed, [0],
        contractInfo['contract'], amount, txFee, satoshisPerBytes, [], false);
