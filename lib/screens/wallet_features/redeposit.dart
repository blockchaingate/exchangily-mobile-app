...
class _RedepositState extends State<Redeposit> {
  ...
  checkPass(context) async {
    ...
    if (res.confirmed) {
      ...
      if(errDepositItem == null) {
        walletService.showInfoFlushbar('Redeposit error', 'Redeposit item not selected.',
      ...
      var resRedeposit = await this.submitredeposit(
          amountInLink, keyPairKanban, nonce, coinType, transactionID, signedMess);
  ...
  submitredeposit(amountInLink, keyPairKanban, nonce, coinType,
      transactionID, signedMess) async {
        ...
        Container(
            ...
            child: ListView(
              children: <Widget>[
                ...
                Column(
                  children:
                  errDepositList.map((data) => RadioListTile(
                    title: Text(
