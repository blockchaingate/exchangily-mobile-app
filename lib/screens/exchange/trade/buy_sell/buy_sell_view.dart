  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<TradeViewModel>.reactive(
        ...
        builder: (context, model, child) => Scaffold(
            ...
            appBar: buildCupertinoNavigationBar(context, model),
...
----------------------------------------------------------------------*/
  ...
  Row buildBuySellTabRow(TradeViewModel model, BuildContext context) {
    return Row(
      children: <Widget>[
        Container(
            decoration: BoxDecoration(
...
----------------------------------------------------------------------*/
  ...
  CupertinoNavigationBar buildCupertinoNavigationBar(
      BuildContext context, TradeViewModel model) {
...
class BalanceRowWidget extends StatelessWidget {
  ...
  Row buildTransferRow(BuildContext context, TradeViewModel model) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
