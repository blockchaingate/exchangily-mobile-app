...
class _MainNavCircleState extends State<MainNavCircle> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FancyBottomNavigation(
        tabs: [
          TabData(iconData: FontAwesomeIcons.wallet, title: AppLocalizations.of(context).wallet),
          TabData(iconData: FontAwesomeIcons.coins, title: AppLocalizations.of(context).trade),
          TabData(iconData: Icons.event, title: AppLocalizations.of(context).event),
          TabData(iconData: FontAwesomeIcons.cog, title: AppLocalizations.of(context).settings)
        ],
        initialSelection: 0,
  ...
  _getPage(int page) {
    switch (page) {
      case 0:
        return WalletDashboardScreen(walletInfo: null);
      case 1:
        return Market();
      case 2:
